...
//     bookList.addEventListener('click',()=> { bookData(book); renderNames(book)})
// }
...
//     likeBtn.addEventListener('click',(books)=> {
...
//     data.append(bookThumbnail, bookDes, likeBtn)
// }
// function renderNames(books){
//     console.log(books)
//     const data = document.querySelector('div#show-panel')
...
//         },
//         body: JSON.stringify({
//             'users': [...books.users, {'id': 1, 'username': 'alelda'}]
//         })
//     })
//     .then(res=>res.json())
//     .then(book => bookData(book))
// }
